...
const DashboardRecievedOrder = ({ handlePendingOrder, handleSendAssetsByEmail, formatIsoDateToHumanReadable }) => {
  ...
  order?.status === "approved"
    ...
    : handlePendingOrder
} className="w-full md:w-4/12 xl:w-5/12 flex flex-col gap-3">
