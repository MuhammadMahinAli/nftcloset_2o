...
const DashboardApprovedOrder = ({handlePendingOrder, handleSendAssetsByEmail, formatIsoDateToHumanReadable }) => {
          ...
          <div className="flex justify-between items-center  py-5">
            ...
            <div className="flex justify-between items-center space-x-5">
              ...
              <p
                ...
                className="text-sm xl:text-xl  text-gray-700"
              >
                Track
              </p>
            </div>
...
export default DashboardApprovedOrder;
