    ...
    <div className="p-7">
      ...
      <ul className="grid grid-cols-6 gap-5">
        <li
          ...
          className={`text-center pb-2 border-b text-xl font-bold cursor-pointer 
                    ${
                      isAll
      ...
      <div className="p-6 rounded-2xl bg-[#f4f4f4] transition-colors duration-200 mt-10">
        <div className="flex justify-between items-center  py-5">
          ...
          <div className="flex items-center gap-6">
            ...
            <p className="text-base  text-gray-700">on tue, 12 nov</p>
            </div>
          </div>

          {/* right */}
          <div className="flex justify-between items-center space-x-5">
          <button className="px-3 py-2 rounded-md text-lg  text-white bg-[#2CBA7A] hover:text-primary/80">
           Confirm reciept
          </button>
          <p className="text-xl  text-gray-700">Track</p>
          </div>
        ...
        <div className=" bg-white border rounded-2xl shadow-lg p-5">
          <div className="flex justify-between items-center pb-7">
            <div className="rounded-lg overflow-hidden flex justify-between items-center space-x-3">
              <div className="w-44 h-48 bg-gray-200 flex justify-center items-center rounded-xl">
                <img
              ...
              <div className=" ">
                ...
                <p className="text-lg text-gray-500 -foreground mt-1">
                  Lorem ipsum dolor icing elit. Quod, at!
                </p>
                <p className="text-lg text-gray-500 -foreground mt-1">Size: L,S</p>
              </div>
            </div>

            <div className="w-5/12 flex flex-col gap-3">
              <button className="py-4 rounded-md text-xl font-medium bg-black text-white text-primary-foreground hover:bg-primary/90">
                Claim Your Digital Assets
              </button>
              <button className="py-4 rounded-md text-xl font-medium text-black border border-black text-primary-foreground hover:bg-primary/90">
                Claim Your Digital Assets
              </button>
            </div>
          </div>
          <hr />
          <p className="text-lg pt-5 text-gray-500 text-muted-foreground">
